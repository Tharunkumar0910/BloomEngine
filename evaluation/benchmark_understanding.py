...
def run_benchmark(dataset_name: str, dataset_path: str):
    ...
    from core.question_understanding import profile_cache
    profile_cache.clear()
...
if __name__ == "__main__":
    ds_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../datasets/evaluation"))
    run_benchmark("100-Question Subset", os.path.join(ds_dir, "benchmark_dataset_100.json"))
    run_benchmark("Full Dataset", os.path.join(ds_dir, "benchmark_dataset.json"))
